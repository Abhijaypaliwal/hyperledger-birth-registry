...
async function store(req, res, next) {
    ...
    try {
        ...
        let getUser = await helper.getRegisteredUser("user", "Org1", true);
		console.log("ghfghgfhfgh",peers, channelName, chaincodeName, fcn, args, "user", "Org1");
        console.log("getUser",getUser);
        console.log("message",message.tx_id);
